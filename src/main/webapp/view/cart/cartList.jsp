                    ...
                    function stringToObjFunc(listOriginal, listLength) {
                        ...
                        for (let i = 0; i < 2; i++) {
                            ...
                            for (let j = 0; j < listOriginal.length; j++) {
                                listIndex = listObj[j].slice(listObj[j].indexOf('=') + 1, listObj[j].length);
                            ...
                            <table class="w3-table w3-bordered" style="width: 80%; margin-left: 30px;">
                                <c:forEach var="c" items="${list }">
                                    ...
                                    <tr>
                                        <td>
                                            <p>
                                                <input type="checkbox" class="w3-check" id="${c.dnum}" value="" name="did"
                                                    onclick="checkBoxValueOnOff(this.id)">
