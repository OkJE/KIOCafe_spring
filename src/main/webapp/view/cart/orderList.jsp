                    ...
                    <form method="post" name="form">
                        ...
                        <table class="order-table">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="c" items="${list }">
                                    ...
                                    <input type="hidden" class="w3-check" id="${did}" value="1" name="did" />
                        ...
                        <table class="board_write">
                            ...
                            <tbody>
                                <tr class="bd_top">
                                    <th scope="row">이름</th>
                                    <td><input type="text" class="text" style="width: 200px;" value=""></td>
                                </tr>
                                <tr>
                                    <th scope="row">휴대폰번호</th>
                                    <td><input type="text" class="text" numberonly="true" maxlength="20" value=""
                        ...
                        <table class="board_write">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">휴대폰번호</th>
                                    <td><input type="text" id="rcvMobile" class="text" numberonly="true" maxlength="20"
                                            value="" placeholder="휴대폰 입력 (숫자만)"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="address-input">
                                        <div>
                                            <input type="text" id="addressInput1" class="text" name="daddress"
                                                style="width: 350px;"> <input type="button" class="btn1"
                        ...
                        <table class="board_write ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 15px"><input type='radio' name='dpaym' value="0"
                                            style="margin-right: 5px;" /><label>무통장입금</label> <input type='radio'
                                            name='dpaym' value="1"
