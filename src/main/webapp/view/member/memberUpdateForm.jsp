            ...
            function sample4_execDaumPostcode() {
                new daum.Postcode({
                    oncomplete: function (data) {
                        ...
                        // 우편번호
                        document.getElementById("addressInput1").value = "(" + String(data.zonecode) + ") " + inputAddress;
            ...
            <div class="cont_title01 " style="width: 75%; margin: auto;">
                ...
                <table class="board_write">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">아이디</th>
                            <td style="display: flex;"><input type="text" placeholder="아이디를 입력해주세요." class="text"
                                    name="id" id="inputId" value="${sessionScope.id}" style="width:200px;">
                        ...
                        <tr>
                            ...
                            <td><input type="password" placeholder="비밀번호를 입력해주세요." class="text" name="pass"
                                    id="inputPass1" style="width:200px;">
                            </td>
                        </tr>

                        <tr>
                            <th scope="row">이름</th>
                            <td><input type="text" class="text" name="name" id="inputName" value="${m.name}"
                                    style="width:200px;">
                            </td>
                        </tr>
                        <tr>
                            <th scope=" row">닉네임</th>
                            <td><input type="text" class="text" name="nickname" value="${m.nickname}"
                                    style="width:200px;">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">이메일</th>
                            <td><input type="text" class="text" name="email" value="${m.tel}" style=" width:200px;">
                            </td>
                        </tr>
                        <tr>
                            <th scope=" row">전화번호</th>
                            <td><input type="text" class="text" name="tel" value="${m.tel}"></td>
                        </tr>
                        <tr>
                            <th scope=" row">이메일</th>
                            <td><input type="text" class="text" name="email" value="${m.email}"></td>
                        </tr>
                        <tr>
                            <th scope=" row">주소</th>
